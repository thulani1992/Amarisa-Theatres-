...
<?php
	...
	{
		switch($_GET['quality']){
			case "basic" : $base_price = 10; break;
			case "medium" : $base_price = 15; break;
			case "high" : $base_price = 20; break;
			default : echo 'The quality must be basic, medium or high' + '<a href="order.html">Retry</a>'; break;
		}
		...
		echo '<p><a href="order.html">order more</a></p></div>';
